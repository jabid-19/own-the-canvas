...
export function ClothSimulationPage() {
  return (
    ...
    >
      <PreviewBox playgroundId="ClothSimulation">
        <ClothSimulation width="100%" height="100%" />
      </PreviewBox>

      <section className="page-section" aria-labelledby="usage-h">
        <h2 className="page-h2" id="usage-h">Usage</h2>
        <CodeBlock code={`import { ClothSimulation } from 'own-the-canvas';
...
// Tearable spider web
<ClothSimulation preset="spider" tearable />`} language="tsx" />
      </section>
